...
#ifndef CYD_UI_MUSIC_PLAYER_HPP
#define CYD_UI_MUSIC_PLAYER_HPP
...
STATE(MusicPlayer)
  cydui::layout::color::Color* c_fg = new cydui::layout::color::Color("#00FF07");
  INIT_STATE(MusicPlayer) {
    border.color = c_fg;
  }
};

COMPONENT(MusicPlayer)
  NO_PROPS INIT(MusicPlayer) }
