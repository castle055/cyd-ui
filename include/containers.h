...
namespace containers {
  ...
  class VBox: public Component {;
    ...
    bool border;
  public:
    explicit VBox(ComponentState* state, bool border, int spacing, std::vector<cydui::components::Component*> children);
  };
  ...
  class HBox: public Component {;
    ...
    bool border;
  public:
    explicit HBox(ComponentState* state, bool border, int spacing, std::vector<cydui::components::Component*> children);
  };
