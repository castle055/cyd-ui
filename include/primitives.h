...
namespace primitives {
  ...
  class Rectangle: public Component {;
    ...
    void on_redraw(CLayoutEvent* ev) override;
  public:
    explicit Rectangle(Color* color, int x, int y, int w, int h, bool filled = false);
  };
  ...
  class Arc: public Component {;
    ...
    void on_redraw(CLayoutEvent* ev) override;
  public:
    explicit Arc(Color* color, int x, int y, int w, int h, int a0, int a1, bool filled = false);
  };
  ...
  class Circle: public Component {;
    ...
    void on_redraw(CLayoutEvent* ev) override;
  public:
    explicit Circle(Color* color, int x, int y, int w, int h, bool filled = false);
  };
