...
namespace cydui {
  ...
  export struct animation_state {
    ...
    animation_state(
      ...
      components::mounted_component_t&      component_,
  ...
  private:
    void run() {
      ...
      std::forward_list<components::mounted_component_t*> c_pending_compose{};
      std::forward_list<components::mounted_component_t*> c_pending_repaint{};
      std::forward_list<components::mounted_component_t*> c_pending_reflow{};
      std::forward_list<components::mounted_component_t*> c_pending_full_update{};
  ...
  public:
    ...
    void clear_animations_for_component(components::mounted_component_t& component) {
