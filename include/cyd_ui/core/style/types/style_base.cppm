...
export namespace cydui::style {
  ...
  struct style_base_t {
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t    x;
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t    y;
    [[meta(animations::AnimationComplexity::FULL_UPDATE)]] position_e position{position_e::RELATIVE};
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t    width;
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t    height;
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t    max_width;
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t    max_height;
    [[meta(animations::AnimationComplexity::REFLOW)]] four_sided_property<expression_t> margin;
    [[meta(animations::AnimationComplexity::REFLOW)]] four_sided_property<expression_t> padding;
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t                      scroll_x;
    [[meta(animations::AnimationComplexity::REFLOW)]] expression_t                      scroll_y;
    ...
    [[meta(animations::AnimationComplexity::REPAINT)]] [[meta(
      CustomConversion::from<Color>([](const refl::any& clr) -> refl::any {
        return refl::any::make<vg::paint::type>(
          vg::paint::type::make(vg::paint::solid(clr.as<Color>()))
        );
      })
    )]]
    ...
    [[meta(animations::AnimationComplexity::REPAINT)]] four_sided_property<int>    border_width{0, 0, 0, 0};
    [[meta(animations::AnimationComplexity::REPAINT)]] four_cornered_property<int> border_radius{0, 0, 0, 0};
    [[meta(
      animations::AnimationComplexity::REPAINT
    )]] four_sided_property<std::valarray<double>>                     border_dasharray{};

    [[meta(animations::AnimationComplexity::COMPOSE)]] la::scalar opacity{1.0f};
    [[meta(animations::AnimationComplexity::COMPOSE)]] la::scalar translate_x{0.0f};
    [[meta(animations::AnimationComplexity::COMPOSE)]] la::scalar translate_y{0.0f};
    [[meta(animations::AnimationComplexity::COMPOSE)]] la::scalar scale_x{1.0f};
    [[meta(animations::AnimationComplexity::COMPOSE)]] la::scalar scale_y{1.0f};
...
struct __static_init {
  __static_init() {
    cydui::style::set_custom_type_conversion<cydui::Color, vg::paint::type>(
      [](const refl::any& it) {
        return refl::any::make<vg::paint::type>(
          vg::paint::type::make(vg::paint::solid(it.as<cydui::Color>()))
        );
      }
    );
