...
namespace cydui {
  namespace animations {
    ...
    public:
      ...
      virtual float_type interpolate(
        float_type x0,
        float_type x1,
        float_type t
      ) const = 0;
  ...
  namespace interp {
    export class lerp final: public animations::interpolator_base {
    public:
      lerp() = default;
    ...
    export class easing final: public animations::interpolator_base {
    public:
      using function_type = cydui::easing::function_type;
      explicit easing(function_type fun)
          : fun_(fun) {}
      float_type interpolate(
        float_type x0,
        float_type x1,
    ...
    export class bezier final: public animations::interpolator_base {
    public:
