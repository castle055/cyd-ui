...
export module cydui.elements.Polyline;
...
export namespace cydui::elements {
  struct Polyline: attributes::attrs_core<Polyline>,
                   attributes::attrs_fill<Polyline>,
                   attributes::attrs_stroke<Polyline>,
                   attributes::attr_points<Polyline> {
    Polyline() {
