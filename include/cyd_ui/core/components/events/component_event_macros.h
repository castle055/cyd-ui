...
#define CYDUI_INTERNAL_EV_mount_ARGS                                                               \
  (cydui::dimension_t & $x,                                                                        \
   ...
   const cydui::core::content_type& $content)
...
#define CYDUI_INTERNAL_EV_redraw_RETURN cydui::core::content_type
