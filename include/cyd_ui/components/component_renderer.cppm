...
namespace cydui::components {
  ...
  public:
    ...
    fabric::wiring::output_signal<component_renderer_t, compositing::compositing_node_t*>
      compositing_signal{};
      ...
      update_fragments(component);
      {
        ...
        Application::run(
          [](
            ...
            graphics::window_t*           w,
            components::component_base_t* component_
          ) {
  ...
  private:
    ...
    bool update_compositing_operation(
    ...
    void
    update_fragment(component_base_t* component, compositing::compositing_node_t* parent_node) {
    ...
    void
    paint_fragment(component_base_t* component, compositing::compositing_node_t& compositing_node) {
    ...
    std::pair<compositing::compositing_node_t*, bool>
    compose(component_base_t* component, graphics::window_t* render_target) {
      auto& data            = component->get_data<render_data_t>();
