...
cydui::graphics::window_t* cydui::graphics::create_window(const char* title,
    const char* wclass,
    int x,
    int y,
    int w,
  ...
  win->staging_drawable = XCreatePixmap(state::get_dpy(),
      xwin,
      w,
      h,
      DefaultDepth(state::get_dpy(), state::get_screen()));
...
void cydui::graphics::drw_line(window_t* win,
...
void cydui::graphics::drw_rect(window_t* win,
    cydui::layout::color::Color* color,
    int x,
    int y,
    int w,
...
void cydui::graphics::drw_arc(window_t* win,
    cydui::layout::color::Color* color,
    int x,
    int y,
    int w,
...
void cydui::graphics::drw_text(window_t* win,
...
void cydui::graphics::drw_image(
    window_t* win, layout::images::image_t* img, int x, int y, int w, int h) {
